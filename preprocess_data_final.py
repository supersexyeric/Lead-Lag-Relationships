...
# --- Configuration ---
DATA_FILES = {
    "btc": "/home/ubuntu/upload/btcusdt_1m_data.csv",
    "eth": "/home/ubuntu/upload/ethusdt_1m_data.csv",
    "sol": "/home/ubuntu/upload/solusdt_1m_data.csv"
}
OUTPUT_DIR = "/home/ubuntu/"
OUTPUT_FILE = os.path.join(OUTPUT_DIR, "preprocessed_crypto_data.csv")
...
for symbol, filepath in DATA_FILES.items():
    ...
    try:
        ...
        df[f"{symbol}_volatility"] = df[f"{symbol}_log_return"].rolling(window=20).std() * np.sqrt(20) # Example: 20-period volatility
